<template>
    <div class="container h-100 top-0 left-0">
        <nav class="navbar navbar-expand-lg navbar-light flex-column me-3 ms-3">
            <!-- <nav> -->
            <RouterLink class="navbar-brand text-light fs-2 fw-bolder" to="/">嗜甜甜點</RouterLink>
